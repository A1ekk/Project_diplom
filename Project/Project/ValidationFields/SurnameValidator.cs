...
{
    class SurnameValidator : ValidationRule
    {
        ...
        public override ValidationResult Validate(object value, System.Globalization.CultureInfo cultureInfo)
        {
            ...
            {
                return new ValidationResult(false, "Необходимо указать фамилию.");
            }
            else if (!Regex.IsMatch(value.ToString(), _regex))
            {
                return new ValidationResult(false, "Фамилия должна состоять из кириллицы.");
            }
